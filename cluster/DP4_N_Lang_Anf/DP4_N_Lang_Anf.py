...
probs[1][81:101] = 10*norm.pdf(np.arange(81, 101), 90, 10)
probs[2][61:101] = 10*norm.pdf(np.arange(61, 101), 80, 10)
probs[3][41:101] = 10*norm.pdf(np.arange(41, 101), 70, 10)
probs[4][21:101] = 10*norm.pdf(np.arange(21, 101), 50, 10)
probs[5][1:101] = 10*norm.pdf(np.arange(1, 101), 20, 10)
