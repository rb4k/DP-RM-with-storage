...
probs[1][81:101] = norm.pdf(np.arange(81, 101), 90, 2)
probs[2][81:101] = norm.pdf(np.arange(81, 101), 90, 2)
probs[3][61:101] = 5*norm.pdf(np.arange(61, 101), 70, 10)
probs[4][61:101] = 5*norm.pdf(np.arange(61, 101), 70, 10)
probs[5][41:101] = 5*norm.pdf(np.arange(41, 101), 50, 10)
probs[6][41:101] = 5*norm.pdf(np.arange(41, 101), 50, 10)
probs[7][21:101] = 5*norm.pdf(np.arange(21, 101), 30, 10)
probs[8][21:101] = 5*norm.pdf(np.arange(21, 101), 30, 10)
probs[9][1:101] = 15*norm.pdf(np.arange(1, 101), 10, 30)
probs[10][1:101] = 15*norm.pdf(np.arange(1, 101), 10, 30)
